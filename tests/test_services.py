...
@pytest.mark.parametrize(
        ...
        [
            (DocsSrcXML.get_doc("order"), "order_converted.json", CorrectTestDocJSON.get_test_doc("order")),
            (DocsSrcXML.get_doc("book"), "book_converted.json", CorrectTestDocJSON.get_test_doc("book")),
            (DocsSrcXML.get_doc("big_data_file"), "big_data_converted.json", CorrectTestDocJSON.get_test_doc("big_data")),
            (DocsSrcXML.get_doc("company"), "company_converted.json", CorrectTestDocJSON.get_test_doc("company")),
        ]
)
